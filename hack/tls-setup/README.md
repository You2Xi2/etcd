...
2. Amend <https://go.etcd.io/etcd/blob/master/hack/tls-setup/config/req-csr.json> - IP's currently in the config should be replaced/added with IP addresses of each cluster node, please note 127.0.0.1 is always required for loopback purposes:
