...
A simple example application, _raftexample_, is also available to help illustrate how to use this package in practice: <https://go.etcd.io/etcd/tree/master/contrib/raftexample>
...
- [etcd](https://go.etcd.io/etcd) A distributed reliable key-value store
